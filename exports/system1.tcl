...
################################################################
# This is a generated script based on design: system1
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set aah [ create_bd_port -dir O -from 0 -to 0 aah ]
  set areset [ create_bd_port -dir I -from 0 -to 0 areset ]
  set bump_left [ create_bd_port -dir I -from 0 -to 0 bump_left ]
  set bump_right [ create_bd_port -dir I -from 0 -to 0 bump_right ]
  set clk [ create_bd_port -dir O -type clk clk ]
  set dig [ create_bd_port -dir I -from 0 -to 0 dig ]
  set digging [ create_bd_port -dir O -from 0 -to 0 digging ]
  set ground [ create_bd_port -dir I -from 0 -to 0 ground ]
  set jumping [ create_bd_port -dir O -from 0 -to 0 jumping ]
  set small_bump_left [ create_bd_port -dir I -from 0 -to 0 small_bump_left ]
  set small_bump_right [ create_bd_port -dir I -from 0 -to 0 small_bump_right ]
  set walk_left [ create_bd_port -dir O -from 0 -to 0 walk_left ]
  set walk_right [ create_bd_port -dir O -from 0 -to 0 walk_right ]
  ...
  set_property CONFIG.DIN_WIDTH {5} $xlslice_3
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins btn/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins led/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net In0_0_1 [get_bd_ports areset] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net In1_0_1 [get_bd_ports bump_left] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net In2_0_1 [get_bd_ports small_bump_left] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net In3_0_1 [get_bd_ports bump_right] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net In4_0_1 [get_bd_ports small_bump_right] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net In5_0_1 [get_bd_ports ground] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net In6_0_1 [get_bd_ports dig] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net led_gpio_io_o [get_bd_pins led/gpio_io_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins btn/gpio_io_i] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports walk_left] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports walk_right] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports aah] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_ports digging] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_ports jumping] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports clk] [get_bd_pins btn/s_axi_aclk] [get_bd_pins led/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs btn/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs led/S_AXI/Reg] -force
